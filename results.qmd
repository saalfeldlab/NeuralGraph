...
**360 iterations completed** across 30 regimes. n_frames is the dominant lever for dense supercritical networks: n=300 and n=600 both achieve 100% convergence at 30k frames; **n=1000 achieves 100% convergence (12/12) at 100k frames with conn=1.000** (block 30 breakthrough). Low gain (g=3) is rescued by 30k frames; g=2 is partially rescued (42% at n=100/30k, 92% at n=200/30k). Three structural limits confirmed: subcritical spectral radius (sparse 50%, conn~0.44), partial connectivity ceiling (fill=80%/90%, conn ≈ filling_factor), and fixed-point collapse (g=1, eff_rank drops to 1 at 30k). The gain--eff_rank relationship depends on n_neurons: at n=100, g=1→5, g=2→17, g=3→26, g=7→35; but at n=200, g=2→35--38 (n compensates for gain reduction). ~99 principles established.
:::
...
12. **n=1000 at 100k frames is SOLVED (block 30 breakthrough)**: 100% convergence (12/12), conn=1.000, test_R^2^=0.882. lr_W=3E-3 optimal; batch=16 safe; 3 epochs sufficient. Confirms the n_frames scaling law: n=1000 needs ~100k frames, matching the pattern established at smaller n.
...
| 29 | **g=2 n=200 (30k)** | **30k** | 200 | **~35--38** | **92%** (11/12) | **0.979** | **n compensates gain: eff_rank matches g=7/n=100** |
| 30 | **n=1000 (100k)** | **100k** | 1000 | **~350** | **100%** (12/12) | **1.000** | **BREAKTHROUGH: 100k solves n=1000; lr_W=3E-3** |
...
| 200 | **30k** | g=2 | **35--38** | >1.0 | **92%** | **n compensates: eff_rank matches g=7/n=100** |
...
**Block 29 update (g=2/n=200/30k)**: Scaling to n=200 dramatically changes the picture. eff_rank jumps from 16--17 (n=100) to 35--38 (n=200), matching g=7/n=100. Convergence rate rises to 92% (11/12), with best conn=0.979 at lr_W=3E-4/12ep. The inverse lr_W pattern persists but the ceiling is higher (1E-3 safe at n=200 vs catastrophic at n=100). Epoch scaling remains strong but diminishes at 12ep (+0.3%). This confirms that n_neurons compensates for gain reduction: g=2/n=200/30k is comparable in difficulty to g=7/n=200/10k.
:::
...
### 13. n=1000 --- Scale Frontier (Blocks 18, 30)

**Block 18 (30k frames)**: Insufficient --- max conn=0.745 (0% convergence). lr=1E-4 Pareto-optimal; lr=2E-4 causes overtraining.

| n_frames | n_epochs | lr_W | conn | test_R^2^ | Key |
|:--------:|:--------:|:----:|:----:|:---------:|:----|
...
n=1000 at 100k frames achieves **100% convergence** (12/12), conn=1.000. This confirms the n_frames scaling law: like n=300 (needs 30k) and n=600 (needs 30k), n=1000 needs ~100k frames. lr_W=3E-3 is optimal; batch=16 is safe; 3 epochs suffice. eff_rank ~350 at 100k frames. The n=1000 regime is now a **solved regime** --- joining n=300/30k, n=600/30k, and g=3/n=200/30k.
:::
...
| 29 | **g=2 n=200 (30k)** | **30k** | **0/12** | **0.12** | **Healthy --- n compensates; eff_rank=35--38** |
| 30 | **n=1000 (100k)** | **100k** | **0/12** | **0.12** | **Healthy --- 100k eliminates degeneracy** |
...
| **1000** | **7** | **100k** | **~350** | **100%** (12/12) | **1.000** | **100k SOLVES n=1000** |

::: {.callout-important}
## Key Finding

n_frames transforms the training landscape for dense supercritical networks:

1. **eff_rank scales with n_frames**: n=300: 47-->80 (30k); n=600: 50-->87 (30k); n=1000: 144-->~350 (100k); g=3/n=200: 31-->55 (30k)
2. **Convergence universalizes**: n=300 (25%-->100%), n=600 (0%-->100%), g=3/n=200 (0%-->100%), **n=1000 (0%-->100% at 100k)**
3. **Training params become non-critical**: lr_W safe range widens; batch_size=16 safe; 1--3 epochs suffice
4. **Optimal lr_W shifts lower**: 3--5E-3 at 30k vs 1E-2 at 10k; 3E-3 at 100k for n=1000

**Exceptions**: sparse 50% (rho<1), fill=80%/90%, g=1 (fixed-point collapse). g=2/n=100 is partially rescued (42% at 30k); g=2/n=200 is mostly rescued (92% at 30k, eff_rank=35--38)
:::
...
::: {.feature-card}
### 10 Solved Regimes
100% convergence (chaotic, noise, n=200, n=200+4types, n=300/30k, n=600/30k, g=3/n=200/30k, **n=1000/100k**)
:::
