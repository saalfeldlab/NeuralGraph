...
if __name__ == "__main__":
    ...
    for config_file_ in config_list:
        ...
        if "train" in task:
            ...
            print("  Learning: connectivity W, latent vectors a_i, functions phi* and psi*")
        ...
        if "test" in task:
            ...
            print("-" * 80)
            print("  Testing prediction accuracy and rollout inference")
        ...
        if 'plot' in task:
            ...
            print("-" * 80)
            print("  Fig 2a: Kinograph (activity heatmap)")
            print("  Fig 2b: Activity traces")
            print("  Fig 2c: True connectivity matrix")
            print("  Fig 2d: Learned connectivity matrix")
            print("  Fig 2e: W learned vs true (R^2, slope)")
            print("  Fig 2f: Latent vectors a_i (4 clusters)")
            print("  Fig 2g: Update functions phi*(a_i, x)")
            print("  Fig 2h: Transfer function psi*(x)")
            print(f"  Output: {log_dir}/results/")
            print()
