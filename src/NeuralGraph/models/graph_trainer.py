...
def data_train_flyvis(config, erase, best_model, device):
    ...
    for run in trange(0,n_runs, ncols=50):
        ...
        x = load_simulation_data(f'graphs_data/{dataset_name}/x_list_{run}', strategy='full')
        y = load_simulation_data(f'graphs_data/{dataset_name}/y_list_{run}', strategy='full')
