...
\caption{\textbf{Epistemic reasoning timeline across 160 iterations (10 blocks).} Each node represents a reasoning event, colored by mode and sized by significance. Edges show causal relationships: solid gray (leads\_to), dashed blue (triggers).}
