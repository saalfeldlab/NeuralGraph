...
if __name__ == "__main__":
    ...
    for config_file_ in config_list:
        ...
        if "train" in task:
            ...
            print("  Learning: connectivity W, latent vectors a_i, functions phi*, psi*")
            print("  Learning: external input field Omega*(x, y, t) via SIREN network")
        ...
        if 'plot' in task:
            ...
            print("-" * 80)
            print("  Fig 3d: W learned vs true (R^2, slope)")
            print("  Fig 3e: Omega learned vs true")
            print("  Fig 3f: True field Omega_i(t) at different times")
            print("  Fig 3g: Learned field Omega*(t) at different times")
            print(f"  Output: {log_dir}/results/")
            print()
