...
# Arrow text labels
fig.add_annotation(
    x=76, y=0.73, text='×3 n_frames<br>10k → 30k',
    showarrow=False, font=dict(size=11, color='#2e7d32'),
)
fig.add_annotation(
    x=10, y=0.26, text='sparse<br>30k fails',
    showarrow=False, font=dict(size=10, color='#c62828'),
)
fig.add_annotation(
    x=44, y=0.87, text='fill=80%<br>30k fails',
    showarrow=False, font=dict(size=10, color='#c62828'),
)
