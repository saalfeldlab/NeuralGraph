...
**348 iterations completed** across 29 regimes. The reasoning trace contains ~420 annotated events connected by ~160 causal edges, ~90 established principles, 74% deduction accuracy, and 70% cross-regime analogy transfer success. 100% of falsified hypotheses led to principle refinement. Blocks 24--29 extended the frontier: fill=90% confirmed conn_ceiling ≈ filling_factor at a 4th data point (block 24), g=1 discovered as a new unsolvable axis --- fixed-point collapse with eff_rank dropping to 1 at 30k (blocks 25--26), g=2 identified as a transitional regime requiring inverse lr_W and partially rescued by 30k frames (blocks 27--28), and g=2/n=200/30k confirmed that n_neurons compensates for gain reduction (block 29, 92% convergence, eff_rank=35--38).
:::
...
1. **~420 reasoning events** across 348 iterations and 29 blocks, connected by ~160 causal edges
...
4. **Principle identification**: ~90 validated findings with confidence 45--100%
...
7. **Cross-block transfer**: Key insights from block 7 (n_epochs) transferred to block 9 (n=300); block 15 (n_frames) transferred to blocks 16--18 and 21; block 22 (fill=80%) extended through block 24 (fill=90%); block 19 (g=3) transferred to blocks 25--29 (g=1, g=2, g=2/n=200)
8. **Paradigm shifts**: Blocks 15--16 (n_frames dominance), blocks 19--21 (gain as solvable difficulty axis), blocks 22--24 (conn_ceiling at filling_factor), blocks 25--26 (g=1 fixed-point collapse), and block 29 (n compensates gain: g=2/n=200 eff_rank matches g=7/n=100) represent five paradigm-level findings. Each overturned or extended previously established principles
