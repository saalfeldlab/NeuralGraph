...
**360 iterations completed** across 30 regimes. The reasoning trace contains ~440 annotated events connected by ~170 causal edges, ~99 established principles, 74% deduction accuracy, and 70% cross-regime analogy transfer success. 100% of falsified hypotheses led to principle refinement. Blocks 24--30 extended the frontier: fill=90% confirmed conn_ceiling ≈ filling_factor at a 4th data point (block 24), g=1 discovered as a new unsolvable axis --- fixed-point collapse with eff_rank dropping to 1 at 30k (blocks 25--26), g=2 identified as a transitional regime requiring inverse lr_W and partially rescued by 30k frames (blocks 27--28), g=2/n=200/30k confirmed that n_neurons compensates for gain reduction (block 29, 92% convergence, eff_rank=35--38), and **n=1000 at 100k frames achieved 100% convergence (12/12, conn=1.000)** confirming the n_frames scaling law at the largest scale tested (block 30).
:::
...
7. **Cross-block transfer**: Key insights from block 7 (n_epochs) transferred to block 9 (n=300); block 15 (n_frames) transferred to blocks 16--18, 21, and 30; block 22 (fill=80%) extended through block 24 (fill=90%); block 19 (g=3) transferred to blocks 25--29 (g=1, g=2, g=2/n=200); block 18 (n=1000/30k insufficient) motivated block 30 (100k)
8. **Paradigm shifts**: Blocks 15--16 (n_frames dominance), blocks 19--21 (gain as solvable difficulty axis), blocks 22--24 (conn_ceiling at filling_factor), blocks 25--26 (g=1 fixed-point collapse), block 29 (n compensates gain: g=2/n=200 eff_rank matches g=7/n=100), and block 30 (n=1000/100k breakthrough: 100% convergence, conn=1.000) represent six paradigm-level findings. Each overturned or extended previously established principles
...
### Block 29 --- g=2/n=200/30k: n Compensates Gain

| Iter | Mode | Event | Outcome |
|------|------|-------|---------:|
| 349 | **Analogy** | g=2/n=200 should have higher eff_rank (like g=3/n=200) | **Confirmed**: eff_rank=35--38 (vs 16 at n=100); 2.2x increase |
...
| 348 | **Causal** | gain × n interaction is compensatory for eff_rank | g=2/n=200 eff_rank=35--38 matches g=7/n=100 |

**Principle extracted**: n_neurons compensates for gain reduction; g=2/n=200/30k achieves 92% convergence (vs 42% at n=100); eff_rank scales with n even at low gain; epoch scaling diminishes at 12ep; lr_W=1E-3 causes negative epoch scaling (cluster degrades).

### Block 30 --- n=1000 at 100k Frames: BREAKTHROUGH (iters 349--360)

| Iter | Mode | Event | Outcome |
|------|------|-------|---------:|
| 349 | **Deduction** | 100k frames should solve n=1000 (block 18 predicted ~100k needed) | **CONFIRMED**: conn=1.000 at first attempt; 12/12 converged |
| 351 | Induction | lr_W=3E-3 optimal at 100k/n=1000 | conn=1.000, test_R^2^=0.882, kino=0.870 |
| 353 | Induction | batch=16 safe at 100k frames | conn=1.000; training time 304 min |
| 355 | Analogy | n_frames scaling law validated at largest scale | 30k→100k follows same pattern as 10k→30k |
| 357 | Deduction | 3ep sufficient at 100k frames | Confirmed: no benefit from >3ep |
| 360 | **Causal** | n_frames scaling law: required frames ~ O(n^1.5) | n=300→30k, n=600→30k, n=1000→100k |

**Principle extracted**: n=1000 at 100k achieves 100% convergence (12/12, conn=1.000); lr_W=3E-3 optimal; batch=16 safe; 3ep sufficient; n_frames scaling law confirmed at largest scale; eff_rank ~350 at 100k.
...
| 76 | **g=2/n=200/30k: n compensates for gain (eff_rank=35--38)** | Block 29 | 85% |
| 77 | **g=2/n=200/30k: 92% convergence (vs 42% at n=100)** | Block 29 | 85% |
| 78 | **epoch scaling diminishes at 12ep for g=2/n=200** | Block 29 | 72% |
| 79 | **lr_W=1E-3 causes negative epoch scaling at g=2/n=200** | Block 29 | 55% |
| 80 | **n=1000/100k achieves 100% convergence (12/12)** | Block 30 | 92% |
| 81 | **n=1000/100k: conn=1.000, lr_W=3E-3 optimal** | Block 30 | 92% |
| 82 | **batch=16 safe at n=1000/100k** | Block 30 | 85% |
| 83 | **3ep sufficient at n=1000/100k** | Block 30 | 85% |
| 84 | **n_frames scaling law: required frames ~ O(n^1.5^)** | Blocks 15--18, 30 | 72% |
...
| 29 | **g=2/n=200 (30k)** | **30k** | 200 | 349--360 | **35--38** | **92%** (11/12) | **n compensates gain; eff_rank matches g=7/n=100** |
| 30 | **n=1000 (100k)** | **100k** | 1000 | 349--360 | **~350** | **100%** (12/12) | **BREAKTHROUGH: 100k solves n=1000; conn=1.000** |
